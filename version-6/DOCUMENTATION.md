...
3. **View Results**
   ...
   - **Confidence Bar:** Shows how certain the model is (0-100%)
...
4. **Stop Detection**
   ...
   - Video stops, statistics remain visible
...
| Edge | ✅ Full | Chromium-based, good performance |
| Safari | ✅ Good | May need HTTPS for camera access |
